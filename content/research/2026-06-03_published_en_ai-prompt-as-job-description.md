---
title: Why Do AI Prompts in Companies Redefine Work?
description: English translation of Kim Minjo's research essay on why prompts in companies reveal intent, judgment criteria, and work structure rather than simply prompt-writing techniques.
type: published
status: published
language: en
...
source_article: "[[2026-06-03_published_ai-prompt-as-job-description]]"
...
English translation of: [회사에서 AI 프롬프트는 왜 업무를 다시 정의하게 만드는가?](/research/2026-06-03_published_ai-prompt-as-job-description)
...
1. Martha S. Feldman and Brian T. Pentland, "Reconceptualizing Organizational Routines as a Source of Flexibility and Change," *Administrative Science Quarterly* 48, no. 1 (2003): 94-118.
2. Ikujiro Nonaka, "A Dynamic Theory of Organizational Knowledge Creation," *Organization Science* 5, no. 1 (1994): 14-37.
3. J. Richard Hackman and Greg R. Oldham, "Motivation through the Design of Work: Test of a Theory," *Organizational Behavior and Human Performance* 16, no. 2 (1976): 250-279.
