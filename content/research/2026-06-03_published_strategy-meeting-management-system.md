...
domain: minjokim.kr
title: "전략은 왜 회의에서 멈추는가?"
subtitle: "전략은 좋은 문장이 아니라 지표, 회의, 책임, 피드백으로 번역될 때 실행된다"
description: "전략이 회의록에 남고 일상 업무로 내려오지 못하는 이유를 성과관리, BSC, 관리통제 시스템 관점에서 살피는 연구 에세이."
language: ko-KR
author: 김민조
source_draft: "[[2026-06-02_draft_strategy-last-language-management-system]]"
source_concepts:
  - "[[MCS_BSC_PMS_실행회로]]"
  - "[[HO_고차자원_성과지속성]]"
  - "[[DM_의사결정모형_조직판단구조]]"
source_notes:
  - "[[2026-05-27_reference_bsc-pms-performance-management]]"
  - "[[2026-05-27_reference_phd-coursework-academic-assets]]"
  - "[[2026-05-27_aitalk_academic-deep-synthesis]]"
  - "[[2026-05-17_minjoimport_book_전략실행-프리미엄-전략을-지속가능한-프로세스로-만드는-BSC-운영시스템]]"
target_format: public_research_essay
human_note: "전략이 실행되지 않을 때 먼저 비어 있는 것은 의지보다 결정, 책임, 일정, 점검이 한 회로로 남는 구조인 경우가 많다."
conclusion_type: diagnostic_question
publication_quality_status: publication_quality_pass
quality_review_date: 2026-06-03
quality_score_average: 4.55
quality_review_log: _logs/2026-06-03_publication-quality-review_strategy-meeting-management-system.md
integrity_status: integrity_pass
reference_truth_audit: pass
reference_truth_audit_date: 2026-06-03
truth_audit: "Kaplan & Norton(1992), Simons(1995), Kaplan & Norton(2008), Mintzberg(1994) 기본 서지 확인. BSC, 관리통제, 전략-운영 연결, 창발전략 논의를 배경 렌즈로만 사용하고 직접 실증 주장으로 확장하지 않음."
style_status: style_pass
academic_review_status: publish_ready
parallel_review_status: publish_ready
parallel_review_file: "[[2026-06-03_parallel-review_strategy-meeting-management-system]]"
visual_brief_status: proposed
visual_brief_file: "[[2026-06-03_visual-brief_strategy-meeting-management-system]]"
seo_status: ready_for_quartz_publish
seo_review_date: 2026-06-04
self_plagiarism_review:
  ...
  status: pass
  risk_level: low
  differentiation: "AI, 조직 양손잡이, 인정/정치가 아니라 전략 문장이 관리시스템을 통해 일상 행동으로 번역되는 조건을 다룬다."
